    ...
    try {
        ...
        if (setusertoken) {
            const mailOptions = {
                ...
                text: `This Link Valid For 5 MINUTES https://crm-of-everyday-finance-solution.onrender.com/forgotpassword/${userfind.id}/${setusertoken.verifytoken}`
            }
...
router.post("/registerationlink", async (req, res) => {
    ...
    const mailOptions = {
        ...
        text: `Use this link to Registration: https://crm-of-everyday-finance-solution.onrender.com/register please dont share this link`
